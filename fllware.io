game.StarterGui:SetCore("SendNotification",  {
 Title = "BeamedWare 3.0 Finally";
 Text = "Made By apfelkopf.og";
...
local MainUI = UILibrary.Load("BeamedWare.CC 3.0 ♥️")
...
local FirstButton = FirstPage.AddButton("Cam Aimlock [C]", function()
